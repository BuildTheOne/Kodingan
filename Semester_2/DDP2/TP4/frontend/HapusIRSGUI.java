...
public class HapusIRSGUI extends JPanel {
    ...
    JLabel titleLabel = new JLabel("Hapus IRS");
    ...
    JButton deleteIRSbtn = new JButton("Hapus");
    ...
    public HapusIRSGUI(JFrame frame, ArrayList<Mahasiswa> daftarMahasiswa, ArrayList<MataKuliah> daftarMataKuliah) {
        ...
        deleteIRSbtn.addActionListener(e -> deleteIRS(frame));
    ...
    public void deleteIRS(JFrame frame) {
        ...
        if (mhs != null && mtkl != null) {
            JOptionPane.showMessageDialog(frame, mhs.dropMatkul(mtkl));
        } else {
